...
#ifndef ISP_YCHE_SERIALNAIVE_H
#define ISP_YCHE_SERIALNAIVE_H

#include <array>

#include "../input_output.h"

class SerialNaiveSim {
private:
    // csr graph
...
public:
    explicit SerialNaiveSim(string &file_path);

    vector<double>& ComputeSim(int max_iter, double eps, double c);
};


#endif //ISP_YCHE_SERIALNAIVE_H
