...
void test_BFLPMC(string data_name, double c, double epsilon, double delta, int pair_num, int round, double r_max) {
    // init graph
    ...
    // init bflpmc object
    auto bflpmc = BFLPMC(data_name, g, c, epsilon, delta, r_max);
...
int main(int args, char *argv[]) {
    ...
    test_BFLPMC(data_name, c, epsilon, delta, pair_num, round_i, r_max);
}