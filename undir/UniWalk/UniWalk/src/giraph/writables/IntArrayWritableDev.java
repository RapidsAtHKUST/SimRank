...
public class IntArrayWritableDev implements Writable {
	int len = 0;
	int[] degrees;
	int target = -1;
	float sim = 0;
	public IntArrayWritableDev(){}
	
	public IntArrayWritableDev(int len){
		this.len = len;
		degrees = new int[len];
	}
	
	public IntArrayWritableDev(IntArrayWritableDev other){
		this.len = other.len;
		this.degrees = Arrays.copyOf(other.degrees, len);
	}
	
	public IntArrayWritableDev(int target, float sim){
		this.target = target;
		this.sim = sim;
	}
