...
Full_LocalPush::Full_LocalPush(DirectedG & g, string name, double c_, double r_max_, size_t n_):LocalPush(g, name, c_,r_max_, n_){
    string data_path =get_file_path_base() + ".P";
    cout << "data path " << data_path << endl;
    if(file_exists(data_path)){ // local push from start
        cout << "file exisis.." << endl;
...
Reduced_LocalPush::Reduced_LocalPush(DirectedG & g, string name, double c_, double r_max_, size_t n_):LocalPush(g, name, c_,r_max_, n_){
    string data_path =get_file_path_base() + ".P";
    // cout << "data path " << data_path << endl;
    if(file_exists(data_path)){ // local push from start
        // cout << "file exisis.." << endl;
