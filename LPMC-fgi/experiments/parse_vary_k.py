...
root_path = '/homes/ywangby/workspace/yche/git-repos/SimRank/LPMC-fgi/experiments/exp_results/vary_k_1'
...
if __name__ == '__main__':
    ...
    #k_lst = [100, 200, 300, 400, 500, 600, 700, 800, 900, 1000, 2000, 5000, 10000, 20000, 50000, 60000, 70000, 80000, 90000, 100000]
    ...
    with open(os.sep.join([data_folder, 'vary_k_58.json']), 'w') as ofs:
