...
root_path = '/homes/ywangby/workspace/yche/git-repos/SimRank/LPMC-fgi/experiments/exp_results/vary_dataset_1'
...
if __name__ == '__main__':
    ...
    with open(os.sep.join([data_folder, 'vary_dataset_42.json']), 'w') as ofs:
