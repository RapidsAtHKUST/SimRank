...
root_path = '/homes/ywangby/workspace/yche/git-repos/SimRank/LPMC-fgi/experiments/exp_results/vary_q_1'
...
if __name__ == '__main__':
    ...
    with open(os.sep.join([data_folder, 'vary_q_1.json']), 'w') as ofs:
