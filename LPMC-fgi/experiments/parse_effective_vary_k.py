...
root_path = '/homes/ywangby/workspace/yche/git-repos/SimRank/LPMC-fgi/experiments/exp_results/effective_vary_k_2'
...
if __name__ == '__main__':
    ...
    with open(os.sep.join([data_folder, 'effective_vary_k_58.json']), 'w') as ofs:
