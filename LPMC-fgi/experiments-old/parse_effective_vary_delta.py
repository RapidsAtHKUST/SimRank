...
root_path = '/homes/ywangby/workspace/yche/git-repos/SimRank/LPMC-fgi/experiments/exp_results/effective_vary_delta'
...
#    'par-sr']
    ...
    with open(os.sep.join([data_folder, 'effective_vary_delta.json']), 'w') as ofs:
