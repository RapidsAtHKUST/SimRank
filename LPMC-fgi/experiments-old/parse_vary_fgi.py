...
root_path = '/homes/ywangby/workspace/yche/git-repos/SimRank/LPMC-fgi/experiments/exp_results/vary_fgi_121'
...
if __name__ == '__main__':
    ...
    q_lst = [10 ** 5]#, 10 ** 6]
    k_lst = [100]
    fgi_lst = xrange(0,3001,500)
    ds = ['ca-GrQc', 'web-Google']
    ...
    with open(os.sep.join([data_folder, 'vary_fgi_121.json']), 'w') as ofs:
