...
def run_exp():
    exec_path_lst = [
            ...
            '/homes/ywangby/workspace/yche/git-repos/SimRank/LPMC-Profile/build/flpmc-topk']
                ...
                for k in [100]:
                    for delta in [0.002,0.006,0.01,0.014,0.018]:
                        for repeat_cnt in xrange(3):
                            ...
                            params_lst = map(str, [algo_path, dataset_name, q, 2, k, 0.01, delta, '>>', stat_file_path])
                            cmd = ' '.join(params_lst)
