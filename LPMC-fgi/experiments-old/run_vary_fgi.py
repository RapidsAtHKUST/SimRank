...
def run_exp():
    exec_path_lst = [
            ...
            '/homes/ywangby/workspace/yche/git-repos/SimRank/LPMC-fgi/build/carmo-t-121']
                ...
                for k in [100]:
                    for fgi in xrange(0,3001,500):
                        for repeat_cnt in xrange(3):
                            ...
                            params_lst = map(str, [algo_path, dataset_name, q, 0, k, 0.01, fgi, '>>', stat_file_path])
                            cmd = ' '.join(params_lst)
