#ifndef _PARTIALSR_H_
#define _PARTIALSR_H_
 ...
 *
 */
class PartialSR : public SimRankMethod {
public:
    PartialSR(int maxsteps, double decayfactor, int *graph_src, int *graph_dst, int mvid, char *graph,
              bool isinit = false, bool ishalf = false) :
